...
const db = firebase.firestore().collection("/studiopick/artists/users");
...
element.addEventListener("submit", (event) => {
  ...
  console.log({ artistName, firstName, email }); // note added braces here
  ...
  firebase
    ...
    .then(async (userCredential) => {
      ...
      window.location.href = "artistdash.html?id=" + uid;

      console.log("Sending Email")
      // Send the confirmation email
      return fetch('http://localhost:3000/send-awelcome', {
        method: 'POST',
        headers: {
